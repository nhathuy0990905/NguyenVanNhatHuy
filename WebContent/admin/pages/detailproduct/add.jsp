									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div>
													<input type="file" name="file" id="profile-img" required="required"> 
													<img src="" id="profile-img-tag" width="400px" style="display: block; margin-left: auto; margin-right: auto;" />
												</div>
											</div>
											<div class="form-actions form-group">
												<button type="submit" class="btn btn-success" name="them">Lưu lại</button>
