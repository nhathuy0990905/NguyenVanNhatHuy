...
<body>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								...
								<a class="btn btn-primary float-right btn-sm" href="AdminListBills">
									DANH SÁCH HÓA ĐƠN
								</a>
							</div>
							<div class="card-body">
								<table id="bootstrap-data-table"
									...
									<tbody>
										<%
											ArrayList<Bills> list = (ArrayList<Bills>) request.getAttribute("listBillsPayment");
											for (Bills l : list) {
										%>
										<tr>
											<td><%=l.getId()%></td>
											...
											<td>
												<a 	class="btn btn-info btn-block btn-sm"
													href="AdminListBillsDetail?idHoaDon=<%=l.getId()%>&thanhtoan=true">
											...
											<td>
												...
												<div>
													<button class="btn btn-secondary mt-1 btn-block btn-sm"
															onclick="ThayDoiTrangThai(<%=l.getId()%>, 3)">
														Hủy
													</button>
												</div>
											</td>
	...
	var datatable = null;
		...
		datatable = $('#bootstrap-data-table-export').DataTable({
		        "columnDefs": [ {
		            "targets": 'no-sort',
		            "orderable": false,
		      } ]
